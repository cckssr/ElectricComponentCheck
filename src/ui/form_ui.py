...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy3.setHeightForWidth(self.barcode.sizePolicy().hasHeightForWidth())
        self.barcode.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.manufacturer.sizePolicy().hasHeightForWidth())
        self.manufacturer.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.type.sizePolicy().hasHeightForWidth())
        self.type.setSizePolicy(sizePolicy3)
        ...
        self.openbis_upload = QPushButton(self.centralwidget)
        self.openbis_upload.setObjectName(u"openbis_upload")
        self.openbis_upload.setEnabled(False)
